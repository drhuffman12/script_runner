...
#      require ENV['AppRoot'].to_s + '/' + 'jdbcmssql-gems'
      ...
      #   - Merge this file and 'get_node_info.py' into one subclass of AbstractClass.
      # See:
      ...
      class GetNodeInfo < AbstractScript
          include Scripting
          ...
          def self.description
            ...
            ret_val << "TODO: Merge this file and 'get_node_info.py' into one subclass of AbstractClass."
            ret_val << AbstractScript.newline
          ...
          def startScriptHook
            ...
            begin
              ...
              # update_progress(@progressCurrent, log_prefix + "description == " + self.class.description)
