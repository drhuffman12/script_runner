...
REM java -jar jruby-complete.jar -S gem install -i jdbcmssql ActiveRecord-JDBC --no-rdoc --no-ri
...
REM java -jar jruby-complete.jar -S gem install -i jdbcmssql rubyzip2 --no-rdoc --no-ri
